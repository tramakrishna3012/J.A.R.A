                ...
                <form onSubmit={handleSignup} className="space-y-4">
                    ...
                    <div className="relative my-6">
                        ...
                        <div className="relative flex justify-center text-sm">
                            <span className="px-2 bg-zinc-900 text-gray-500">Or sign up with</span>
                        </div>
                    </div>
                    ...
                    <button
                        ...
                        className="w-full py-3 bg-zinc-800 text-white rounded-lg font-bold hover:bg-zinc-700 transition flex items-center justify-center gap-2 border border-white/10"
                    >
